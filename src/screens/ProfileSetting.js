            ...
            <View style={styles.container}>
                ...
                <View style={styles.input_with_title}>
                    <View>
                        ...
                        // value={email}
                        />
                        <Text style={[styles.remaining_txt, { textAlign: 'right', bottom: 20 }]}>(30 Max)</Text>
                    </View>
                    <View>
                ...
                <View style={{ marginBottom: 20,alignSelf:'flex-end' }}>
                    <CustomButton text="Update" enabled={true} btnAction={() => navigation.navigate('Favourites')} btnWidth={30} />
                </View>
